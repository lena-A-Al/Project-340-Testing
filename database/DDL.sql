...
DROP TABLE IF EXISTS projects_mapping;
...
FOREIGN KEY (manager_id) REFERENCES managers (manager_id) ON DELETE CASCADE ON UPDATE NO ACTION,
...
FOREIGN KEY(employee_id) REFERENCES employees (employee_id) ON DELETE CASCADE ON UPDATE NO ACTION,
FOREIGN KEY(project_id) REFERENCES projects (project_id) ON DELETE CASCADE ON UPDATE NO ACTION
);
